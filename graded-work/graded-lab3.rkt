...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname graded-lab3) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
...
(check-error (linreg (list (make-posn 1 2))))
(check-within (lineq-m (linreg (list (make-posn 0 2) (make-posn -5 1) (make-posn 15 4)))) 0.1461538 0.0001)
(check-within (lineq-b (linreg (list (make-posn 0 2) (make-posn -5 1) (make-posn 15 4)))) 1.846153 0.0001)


; GRADER: Very nice lab. However, using λ for function definitions is unnecessary.
