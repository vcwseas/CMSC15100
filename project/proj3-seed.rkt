...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname proj3-seed) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f ())))
...
(define (run-mm ply human-player)
  ((λ (x) true)
   (error "todo: run game with minimax")))

;; run-mm-tt : nat player -> bool
;; runs game and returns true
(define (run-mm-tt ply human-player)
  ((λ (x) true)
   (error "todo: code to run game with minimax and transposition table")))
